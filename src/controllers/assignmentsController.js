...
export async function addServicesToAssignment(req, res) {
  try {
    const { id } = req.params;
...
export async function getAssignmentsBySession(req, res) {
  try {
...
export async function listActiveAssignments(req, res) {
  try {
