...
// exports.getUserCommissionReport = async function getUserCommissionReport(req, res) {
//     try {
...
exports.getCommissionSummary = async function getCommissionSummary(req, res) {
    const { from, to } = req.query;
