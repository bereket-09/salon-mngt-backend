const { Booking, Branch, Customer, User, CustomerSession, Service, Assignment, AssignmentService } = require('../models/index')
...
exports.listBookings = async function listBookings(req, res) {
    try {
...
exports.getBooking = async function getBooking(req, res) {
    try {
        const { id } = req.params;
...
exports.updateBookingStatus = async function updateBookingStatus(req, res) {
    try {
        const { id } = req.params;
...
exports.convertBookingToSession = async function convertBookingToSession(req, res) {
    try {
        const { id } = req.params;
...
exports.getBookingStats = async function getBookingStats(req, res) {
    try {
