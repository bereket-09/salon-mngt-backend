...
const { sequelize, Invoice, InvoiceItem, Assignment, AssignmentService, Service, CustomerSession, Customer } = require('../models/index')


exports.generateInvoiceForCustomer = async function generateInvoiceForCustomer(req, res) {
...
exports.markInvoicePaid = async function markInvoicePaid(req, res) {
  const { id } = req.params;
...
exports.listInvoices = async function listInvoices(req, res) {
...
exports.generateInvoiceForSession = async function generateInvoiceForSession(req, res) {
...
exports.listInvoicesForCustomer = async function listInvoicesForCustomer(req, res) {
  const { customerId } = req.params;
