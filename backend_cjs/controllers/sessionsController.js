const { CustomerSession, Customer, Branch, Assignment, Service, User, Invoice, InvoiceItem, Commission, AssignmentService, sequelize } = require('../models/index')

exports.listActiveSessions = async function listActiveSessions(req, res) {
    try {
...
exports.getCustomerSessions = async function getCustomerSessions(req, res) {
    try {
...
exports.completeSession = async function completeSession(req, res) {
...
exports.deleteSession = async function deleteSession(req, res) {
    try {
        const { id } = req.params;
        const session = await CustomerSession.findByPk(id);
